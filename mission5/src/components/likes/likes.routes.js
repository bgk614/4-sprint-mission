...
likeRouter.post('/products/:productId', authenticate, toggleProductLikeController); // 상품 좋아요 토글
likeRouter.post('/articles/:articleId', authenticate, toggleArticleLikeController); // 게시글 좋아요 토글
